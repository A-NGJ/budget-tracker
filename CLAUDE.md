...
A budget tracking TUI written in python. Environment managed by uv.
...
Code quality check should be performed using `scripts/check_quality.py` before committing. If any issues are found, fix them before proceeding.
